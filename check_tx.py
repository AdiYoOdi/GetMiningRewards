...
def check_txs(current_transaction):
    ...
    endpoint = f"https://explorer.hydrachain.org/api/tx/{current_transaction}" #don't forget [i] for loops
...
check_txs(current_transaction="e2f5c46868cf77b47f5376817a637f85d06baa697f49c8b2f4131be6dc590c4e")
